    ...
    <div align="left" class="producto-individual" style="padding-bottom:2%">
        ...
        <form method="POST" action="" style="padding:1em" enctype="multipart/form-data">
            ...
            <div class="d-flex md-form mt-0" style="justify-content:center">
                <a href="/productos/usuario" class="btn btn-info btn-sm" role="button" style="margin:2%;">Volver</a>
                <input type="submit" class="btn btn-info btn-sm" style="margin:2%;" value="Confirmar Cambios">
            </div>
        </form>
        ...
        <form method="POST" action="{{$producto->id}}">
            {{method_field('DELETE')}}
            @csrf
            <button class="btn btn-danger btn-sm" type="submit" value="" style="display:inherit; margin:0 auto;">
                Eliminar Producto
            </button>
        </form>
     </div>
